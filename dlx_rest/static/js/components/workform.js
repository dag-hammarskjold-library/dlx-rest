// This code is incomplete, but it could be useful
        ...
        <div class="row pt-2">
            ...
            <div class="col-10">
                <div v-for="w in auths_workforms" class="row">
                    <span class="mx-2" contenteditable="true">{{w}}</span>
                    <a :href="'/editor?workform=auths/' + w"><i class="fas fa-edit"></i></a>
                </div>
        ...
        <div class="row pt-2">
            ...
            <div class="col-10">
                <div v-for="w in bibs_workforms" class="row">
                    <span class="mx-2">{{w}}</span>
                    <a :href="'/editor?workform=bibs/' + w"><i class="fas fa-edit"></i></a>
                </div>
