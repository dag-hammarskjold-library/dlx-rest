...
<script>
import RecordFieldSubfield from './RecordFieldSubfield.vue'
...
export default {
  ...
  emits: ['field-changed', 'field-selected', 'add-field', 'delete-field', 'delete-selected-fields', 'auth-lookup', 'create-authority', 'open-linked-authority'],
  data() {
    return {
      showMenu: false,
