...
<script>
import RecordstageRecord from './RecordstageRecord.vue'
...
export default {
  ...
  emits: ['focus-record', 'clone-record', 'open-related-record', 'batch-actions', 'record-saved', 'unlock-record', 'delete-record', 'close-record', 'create-record', 'stage-notice', 'refresh-basket'],
  data() {
    return {
      focusedRecord: null,
